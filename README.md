...
# 研究のモチベーション
[Co2L(ICCV2021)](https://arxiv.org/pdf/2106.14413)，[CCLIS(AAAI2024)](https://arxiv.org/pdf/2403.04599)などの既存研究は，[教師あり対照損失(SupCon)](https://arxiv.org/pdf/2004.11362)で獲得した特徴表現は，破滅的忘却に対して頑健であることから，継続学習に教師あり対照損失を導入することで性能向上を図った．
