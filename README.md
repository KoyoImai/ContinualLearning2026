...
これらの研究は，Asymmetric SupCon損失などの導入といった，損失関数を工夫することで，モデルが持つ特徴表現をより頑健にすることに注力しいている一方で，「リプレイバッファ内にどのデータを保持するのが有効か」「リプレイバッファ内のデータをどのように活用するとよいか」に対する議論はあまりされていない．
