"""
参考 github
https://github.com/LAMDA-CL/PyCIL/blob/master/convs/cifar_resnet.py#L177
"""
...
class CifarResNet(nn.Module):
    ...
    def __init__(self, block, depth, channels=3):
        ...
        # self.fc = nn.Linear(64*block.expansion, 10)    # いらないのでコメントアウト
...
model_dict = {
    ...
    'resnet50': [resnet44, 64],
    'resnet101': [resnet56, 64]
}

class SupConResNet(nn.Module):
    def __init__(self, name="resnet20", head="mlp", feat_dim=128):
